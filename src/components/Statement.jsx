...
export default function Statement() {
  return (
    <section className="px-6 md:px-10 lg:px-16 pb-6 md:pb-10">
      <div className="max-w-[1600px] mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          {/* Left: safety quote */}
          <FadeUp>
            <div className="border-t-4 pt-6" style={{ borderColor: '#5C3A0A' }}>
              <p className="text-[clamp(1.1rem,1.6vw,1.5rem)] leading-[1.45] text-grey/80">
            ...
            <div className="grid grid-cols-3 gap-8">
              {stats.map(({ value, label }) => (
                <div key={label} className="pt-5">
                  <p className="text-[clamp(1.8rem,2.8vw,3rem)] font-normal leading-none tracking-[-0.03em] text-grey">
                    {value}
                  </p>
